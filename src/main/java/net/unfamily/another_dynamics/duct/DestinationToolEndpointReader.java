...
public final class DestinationToolEndpointReader {
    private static final ResourceLocation EXTERNAL_FILTER_DESTINATION_TOOL =
    ...
    public static DuctDirectionalEndpoint readFromItemStack(
        ...
        if (!EXTERNAL_FILTER_DESTINATION_TOOL.equals(id)) {
            return null;
        }
    ...
    public static boolean isDestinationTool(ItemStack stack) {
        ...
        return EXTERNAL_FILTER_DESTINATION_TOOL.equals(BuiltInRegistries.ITEM.getKey(stack.getItem()));
    }
