...
/**
 * Registers NeoForge + version-locked soft-dep block capabilities on the Machine Connector (26.1.2).
 */
public final class MachineConnectorCapabilities {
    ...
    public static void register(RegisterCapabilitiesEvent event) {
        ...
        registerSided(event, type, Capabilities.Item.BLOCK);
        registerSided(event, type, Capabilities.Fluid.BLOCK);
        registerSided(event, type, Capabilities.Energy.BLOCK);
    ...
    public static final class SoftProbe {
        ...
        public static Object get(
                Level level, BlockPos pos, @Nullable Direction side, String modId, String className, String field) {
